...
st_centroid(s.geom) AS centroid_placette,
tsc."data"->>'commune' AS commune,
tsc."data"->>'modalite_paturage' AS modalite_paturage,
tsc."data"->>'position_nardaie' AS position_nardaie,
