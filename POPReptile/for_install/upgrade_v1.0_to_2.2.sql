...
CREATE SCHEMA backup_pop_reptile;
CREATE TABLE backup_pop_reptile.tmp_bkp_monitoring_pop AS
(SELECT o.uuid_observation,
	...
	LEFT JOIN gn_commons.t_medias tm ON (tm.id_table_location =
		...
		tm.uuid_attached_row = o.uuid_observation)
...
WITH selection AS
	  ...
	  JOIN gn_monitoring.cor_site_module csm
          ON tc.id_base_site = csm.id_base_site
