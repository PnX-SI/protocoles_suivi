...
SELECT
    ...
    (oc.data ->> 'count_max') :: int AS count_min,
    (oc.data ->> 'count_min') :: int AS count_max,
    o.cd_nom,
...
FROM
    ...
    LEFT JOIN ref_nomenclatures.t_nomenclatures tbb ON tbb.id_nomenclature = (
        oc.data ->> 'id_nomenclature_abondance_braunblanquet'
    ) :: int
    JOIN source ON true
